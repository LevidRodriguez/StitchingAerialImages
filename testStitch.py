...
img1 = cv2.imread('datasets/DJI_0397.JPG')
...
img2 = cv2.imread('datasets/DJI_0398.JPG')
...
print ('A type', type(A))
#
# A = cv2.findHomography(src_pts, dst_pts, cv2.RANSAC, 5.0)
# A = cv2.estimateAffinePartial2D(src_pts,dst_)

# A = cv2.findHomography(src_pts,dst_pts,method=cv2.RANSAC)
# A = cv2.getAffineTransform(src)
# print ("A: ",A)
...
print ('corners1 type: ', type(corners1))
print ('corners2 type: ', type(corners2))
print ('warpedCorners2 type: ', type(warpedCorners2))
